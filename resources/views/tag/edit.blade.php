                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="post-preview">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                              <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{ route('tags.update') }}">
                               @csrf
                                <div class="form-group mb-4">
                                    <input type="text" id="id" name="id" class="form-control" hidden required="" value="{{ $tag->id }}">
